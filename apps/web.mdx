---
title: Web
description: How the website application works in SuperStarter.
---
...
SuperStarter comes with a default website application that is usually called Landing Page, which is located in the `apps/web` folder.
