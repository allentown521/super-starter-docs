---
title: Vercel
description: How to store files with Vercel in your application.
---

SuperStarter provides a simple wrapper around [Vercel Blob](https://vercel.com/docs/storage/vercel-blob) for file storage.
