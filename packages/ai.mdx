---
title: AI
description: How to use AI in ShipThing.
---


ShipThing has a pre-configured `ai` package that uses [ai-sdk](https://sdk.vercel.ai/) to provide a simple interface for interacting with AI models.
...
You can use the `paymentsAgentToolkit` to add payments capabilities to your AI agent for financial services. As ShipThing uses Stripe by default, here's an example of how to use it:
