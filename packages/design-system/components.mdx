---
title: Components
description: ShipThing offers a default component library by shadcn/ui
---

ShipThing contains a design system out of the box powered by [shadcn/ui](https://ui.shadcn.com/).
