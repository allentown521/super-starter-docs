---
title: Components
description: SuperStarter offers a default component library by shadcn/ui
---

SuperStarter contains a design system out of the box powered by [shadcn/ui](https://ui.shadcn.com/).
...
We also have a dedicated command for this. Read more about [updates](/setup/codebase/update).
