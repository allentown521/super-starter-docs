...
Arcjet is configured in SuperStarter with two main features: bot detection and the Arcjet Shield WAF:
...
SuperStarter includes a boilerplate setup for Arcjet that protects against common threats to SaaS applications, but since the rules are defined in code, you can easily adjust them dynamically at runtime.
