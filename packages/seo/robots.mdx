...
ShipThing automatically generates the `robots.txt` for the website using Next.js's built-in [robots generation](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/robots#generate-a-robots-file) functionality (`robots.ts`). 
