...
SuperStarter automatically generates the obots.txt for the website using Next.js's built-in [robots generation](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/robots#generate-a-robots-file) functionality (`robots.ts`). 

The sitemap is automatically regenerated during each build.
