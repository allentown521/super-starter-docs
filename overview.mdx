---
title: Overview
description: What is ShipThing and how do I get started?
---

Welcome to the ShipThing for Next.js documentation. This is the place to get started with the starter kit, learn about the structure, its features and how to use it.

## What is ShipThing?

ShipThing is a fullstack starter kit that helps you build production-ready and scalable web applications faster. It comes with the most common features you need to build a SaaS and and is designed to help you build your new SaaS app as thoroughly as possible, balancing speed and quality.
...
We have a demo version of ShipThing that you can use to get a feel for the project!
...
<Card title="Issues" icon="bug" href="https://github.com/focusapps/ShipThing/issues" horizontal>
  Report bugs or ask for enhancements.
</Card>

<Card title="Pull Requests" icon="hands-clapping" href="https://github.com/focusapps/ShipThing/pulls" horizontal>
  Submit your own improvements.
</Card>

<Card title="Discussions" icon="comments" href="https://github.com/focusapps/ShipThing/discussions" horizontal>
  Discuss the future of ShipThing.
</Card>

## Enjoy! 
This documentation is designed to be easy to follow and understand. If you have any questions or need help, feel free to reach out to us at product@shipthing.com.
