---
title: Coolify
description: Learn how to deploy SuperStarter to Coolify.
---


In this guide we will show you how to easily deploy your SuperStarter SaaS with [Coolify](https://coolify.io/).


## 1. Setup Coolify
Before you can deploy your SuperStarter application with Coolify, you need to have a server and a Coolify account.

Follow the [Coolify setup guide](https://coolify.io/docs/getting-started) to get started.
