...
ShipThing supports multiple languages and allows to switch between them with a language switcher. Per default `English` , `German` ,  `Spanish` , `Chinese` , `French` are provided and enabled.
...
ShipThing has defined a few placeholder pages for legal pages, like privacy policy which you can edit in the `/apps/web/content/legal/*.md` files.
