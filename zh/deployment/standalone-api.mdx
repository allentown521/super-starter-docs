...
description: 了解如何将您的 SuperStarter API 作为独立服务与前端分开部署。
---
...
本指南解释了如何将 SuperStarter API 作为独立服务进行部署。由于 Hono 有多种部署选项（例如 [Deno](https://deno.com/)、[Bun](https://bun.sh/)），本指南将主要关注 [Node.js](https://nodejs.org/) 部署。
