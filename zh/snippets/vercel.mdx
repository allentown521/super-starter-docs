export const VercelButton = () => {
  ...
  url.searchParams.set('demo-title', 'ShipThing');
  ...
  url.searchParams.set('project-name', 'ShipThing');
  url.searchParams.set('repository-name', 'ShipThing');
  url.searchParams.set('repository-url', 'https://github.com/focusapps/ShipThing');
