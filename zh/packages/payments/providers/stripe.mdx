---
title: Stripe
description: 学习如何在SuperStarter中设置Stripe支付。
---

SuperStarter默认使用[Stripe](https://stripe.com/)进行支付和账单处理。在您的项目中集成Stripe非常简单。
...
如果您在每个页面加载中嵌入 Stripe JS 脚本，Stripe Radar 支持更多 [高级反欺诈功能](https://docs.stripe.com/disputes/prevention/advanced-fraud-detection)。默认情况下，这在 SuperStarter 中不启用，但您可以按如下方式添加它:
