...
Yes, we will keep updating SuperStarter with new packages and features. This kit is designed to be modular, allowing for new features and packages to be added without interfering with your existing code. You can always [update your project](/setup/installation/update) to the latest version.
...
Please read the [documentation](/setup/installation/update) for updating your SuperStarter code.
