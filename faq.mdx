---
title: FAQ
description: Frequently asked questions about ShipThing.
---

## I don't know some technology! Should I buy ShipThing?

You should be prepared for a learning curve or consider learning it first. However, ShipThing will still work for you if you're willing to learn.
...
Sure! ShipThing is designed to be modular, so configuring new provider (e.g. for emails, billing or any other service) is straightforward. You just need to make sure your configuration is compatible with common interface to be able to plug it into the codebase.

how do I do that? check out the [migrations](/migrations) for more information.

## Will you add more packages in the future?

Yes, we will keep updating ShipThing with new packages and features. This kit is designed to be modular, allowing for new features and packages to be added without interfering with your existing code. You can always [update your project](/setup/codebase/update) to the latest version.

## Does it set up the production instance for me?

No, ShipThing does not set up the production instance for you. This includes setting up databases, Stripe, or any other services you need. ShipThing does not have access to your Stripe or Resend accounts, so setup on your end is required. ShipThing provides the codebase and documentation to help you set up your SaaS project.

## How do I get support if I encounter issues?

For support, you can:

- Visit our [GitHub repository](https://github.com/focusapps/ShipThing/) for support and feature requests.

- Contact us via support email (product@shipthing.com)
...
Please read the [documentation](/setup/codebase/update) for updating your ShipThing code.
