...
description: Let's use SuperStarter to create a simple AI chatbot.
---

Today we're going to create an AI chatbot using SuperStarter and the built-in AI package, powered by [Vercel AI SDK](https://sdk.vercel.ai/).
...
That's it! You've now created an AI chatbot using SuperStarter and the built-in AI package. If you have any questions, please reach out to me on [Twitter](https://x.com/allentown521) or open an issue on [GitHub](https://github.com/allentown521/SuperStarter).
