export const VercelButton = () => {
  ...
  url.searchParams.set('demo-title', 'SuperStarter');
  url.searchParams.set('demo-url', 'https://superstarter.focusapps.app/');
  ...
  url.searchParams.set('envLink', 'https://docs.superstarter.focusapps.app.com/setup#accounts');
  url.searchParams.set('from', 'templates');
  url.searchParams.set('project-name', 'SuperStarter');
  url.searchParams.set('repository-name', 'SuperStarter');
  url.searchParams.set('repository-url', 'https://github.com/allentown521/SuperStarter');
