...
<Steps>
  ...
  <Step title="Configure the database">
    ...
    For more details on the default Prisma configuration (using Neon), refer to the [Database Configuration Guide](https://docs.superstarter.focusapps.app.com/packages/database#default-configuration).
  </Step>
